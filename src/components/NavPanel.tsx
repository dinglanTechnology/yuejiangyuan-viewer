...
export default function NavPanel({
	...
	return (
		...
		<div className="navpanel-scroll" style={{ position: "relative", flex: 1, overflow: 'auto', paddingBottom: 10 }}>
			{/* 导航 */}
			<div style={{ padding: '10px 12px' }}>
				<div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
					<div style={{ width: 4, height: 18, borderRadius: 2, background: 'linear-gradient(180deg, rgba(110,231,183,0.95), rgba(110,231,183,0.35))', boxShadow: '0 0 10px rgba(110,231,183,0.5)' }} />
					<div style={{ color: '#E6FFF3', fontSize: 16, fontWeight: 700, letterSpacing: 0.5 }}>导航</div>
				</div>
			...
			{(hasImages || hasVideos) && (
				<>
					{/* 导航与媒体分割线 */}
					<div style={{ height: 1, margin: '6px 12px', background: 'linear-gradient(90deg, rgba(255,255,255,0.06), rgba(255,255,255,0.18), rgba(255,255,255,0.06))' }} />
					...
					{hasVideos && (
						<div style={{ padding: '10px 12px' }}>
							<div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
								<div style={{ width: 4, height: 18, borderRadius: 2, background: 'linear-gradient(180deg, rgba(251,191,36,0.95), rgba(251,191,36,0.35))', boxShadow: '0 0 10px rgba(251,191,36,0.4)' }} />
								<div style={{ color: '#FFF8E6', fontSize: 16, fontWeight: 700, letterSpacing: 0.5 }}>视频集</div>
							</div>
							<div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 10 }}>
								{videos!.map((v, idx) => (
									<div key={idx} style={{ border: '1px solid rgba(255,255,255,0.2)', borderRadius: 10, overflow: 'hidden' }}>
										<video src={v} controls style={{ width: '100%', height: 140, objectFit: 'cover', background: 'black' }} />
										</div>
								))}
							</div>
						</div>
